...
-- 角色
INSERT INTO t_sc_roles (id, code, name, description, created_time, updated_time, created_by, updated_by)
...
-- 资源
INSERT INTO t_sc_resource (id, name, code, type, url, method, description, created_time, updated_time, created_by, updated_by)
...
-- 用户关系授权
INSERT INTO t_sc_user_role_relation (id, user_id, role_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system'),
       (103, 102, 103, now(), now(), 'system', 'system');
-- 角色与资源关系表
INSERT INTO t_sc_role_resource_relation (id, role_id, resource_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
